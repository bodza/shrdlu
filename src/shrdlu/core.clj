...
(defn- uprel [x]
    (and (not (term? x))
        (or (memq 'UPREL (features x)) (uprel (daughters x)) (uprel (cdr x))))) ;; FIND NODE WITH UPREL FEATURE
